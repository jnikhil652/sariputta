...
<div class="page-wraper">
    ...
    <div class="page-content">
            ...
            <div class="container">
                <div class="row">
                   <div class="icon-bx-wraper center col-md-3 col-sm-3 bg-green icon-box p-a0">
                        <div class="icon-bx-lg text-white"><a href="<?php echo base_url('our-services'); ?>" class="icon-cell"><i
                    ...
                    <div class="icon-bx-wraper center col-md-3 col-sm-3 bg-red icon-box p-a0">
                        <div class="icon-bx-lg text-white"><a href="<?php echo base_url('higherEducation'); ?>" class="icon-cell"><i
                                        class="fas fa-desktop"></i></a></div>
                        <div class="icon-content text-white p-lr15 p-tb30">
        ...
        <div id="testimonial_3_columns_text_carousel" class="carousel slide testimonial_columns_text_carousel_wrapper"
                    ...
                    <div class="section-content">
                        <div class="row">
                            <div class="col-md-12 text-center section-head">
                                ...
                                <div class="clear"></div>
                                <h1><p class="m-b0">Sariputta Edutech is an education consultant in the training and education industry and helps students develop and meet their career aspirations and dreams.</p></h1>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-4 col-md-4">
                                        <div class="rdx-box rdx-img-effect border-1 mb-1 rotate">
                                            <div class="rdx-media"><a href="<?php echo base_url('our-services'); ?>"><img
                                    ...
                                    <div class="col-xs-12 col-sm-4 col-md-4">
                                        <div class="rdx-box rdx-img-effect border-1 mb-1 rotate">
                                            <div class="rdx-media "><a href="<?php echo base_url('our-services'); ?>"><img
                                                            src="<?php echo base_url(); ?>/assets/img/distanceLearning.jpg"
                                                            alt=""></a>
                                            </div>
                                            <div class="rdx-info p-a20 text-center">
                            ...
                            <div class="item active">
                                <div class="row">
                                    <div class="col-xs-12 col-sm-4 col-md-4">
                                        <div class="rdx-box rdx-img-effect border-1 mb-1 rotate">
                                            <div class="rdx-media "><a href="<?php echo base_url('our-services'); ?>"><img
                                                            src="<?php echo base_url(); ?>/assets/img/councelling.jpg"
                                                            alt=""></a>
                                            </div>
                                            <div class="rdx-info p-a20 text-center">
                                    ...
                                    <div class="col-xs-12 col-sm-4 col-md-4">
                                        <div class="rdx-box rdx-img-effect border-1 mb-1 rotate">
                                            <div class="rdx-media "><a href="<?php echo base_url('our-services'); ?>"><img
                                                            src="<?php echo base_url(); ?>/assets/img/healthcare1.jpg"
                                                            alt=""></a>
                                            </div>
                                            <div class="rdx-info p-a20 text-center">
                                    ...
                                    <div class="col-xs-12 col-sm-4 col-md-4">
                                        <div class="rdx-box rdx-img-effect border-1 mb-1 rotate">
                                            <div class="rdx-media "><a href="<?php echo base_url('our-services'); ?>"><img
                                                            src="<?php echo base_url(); ?>/assets/img/sanitation1.jpg"
                                                            alt=""></a>
                                            </div>
                                            <div class="rdx-info p-a20 text-center">
                        ...
                        <ol class="carousel-indicators testimonial_columns_text_carousel_indicators">
                            <li data-target="#testimonial_3_columns_text_carousel" data-slide-to="0"
                                class="active"></li>
        ...
        <div class="section-full text-white bg-img-fix content-inner bg-primary choose-us"
             style="background-image:url(<?php echo base_url(); ?>/assets/img/patter-bg.png);">
            <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-6 m-b30">
                            <img class="img-fluid img-thumbnail"
                                 src="<?php echo base_url(); ?>/assets/img/custom–1.png">
                        </div>
                        <div class="col-md-3 col-sm-6 m-b30">
                            <img class="img-fluid img-thumbnail"
                                 src="<?php echo base_url(); ?>/assets/img/custom–10.png">
                        </div>
                        <div class="col-md-3 col-sm-6 m-b30">
                            <img class="img-fluid img-thumbnail"
                                 src="<?php echo base_url(); ?>/assets/upgrad.jpg">
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6 m-b30">
                            <img class="img-fluid img-thumbnail"
                                 src="<?php echo base_url(); ?>/assets/img/custom–5.png">
                        </div>
                        <div class="col-md-3 col-sm-6 m-b30">
                            <img class="img-fluid img-thumbnail"
                                 src="<?php echo base_url(); ?>/assets/img/custom–6.png">
                        </div>
                        <div class="col-md-3 col-sm-6 m-b30">
                            <img class="img-fluid img-thumbnail"
                                 src="<?php echo base_url(); ?>/assets/img/custom–7.png">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-3 col-sm-6 m-b30">
                            <img class="img-fluid img-thumbnail"
                                 src="<?php echo base_url(); ?>/assets/img/custom–11.png">
                        </div>
                        <div class="col-md-3 col-sm-6 m-b30">
                            <img class="img-fluid img-thumbnail"
                                 src="<?php echo base_url(); ?>/assets/img/custom–8.png">
                        </div>
                        <div class="col-md-3 col-sm-6 m-b30">
                            <img class="img-fluid img-thumbnail"
                                 src="<?php echo base_url(); ?>/assets/img/expertron_logo.jpg">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
             <div class="section-head text-center ">
                ...
                <div class="row">
                        <div class="col-md-3 col-sm-6 m-b30">
                            <img class="img-fluid img-thumbnail"
                                 src="<?php echo base_url(); ?>/assets/hdfc.png">
                        </div>
                        <div class="col-md-3 col-sm-6 m-b30">
                            <img class="img-fluid img-thumbnail"
                                 src="<?php echo base_url(); ?>/assets/credin.jpeg">
                        </div>
                ...
                <div class="section-content">
                    <div class="row">
                        ...
                        <div class="gallery-product col-md-3 filter events">
                            <img class="img-thumbnail img-fluid" src="<?php echo base_url(); ?>/assets/img/event_lm.jpg"
                                 alt="">
                        </div>
                        <div class="gallery-product col-md-3 filter achivements">
                            <img class="img-thumbnail img-fluid"
                                 src="<?php echo base_url(); ?>/assets/img/gallery/achivement1.jpg" alt="">
                        </div>
                        <div class="gallery-product col-md-3 filter achivements">
                            <img class="img-thumbnail img-fluid"
                                 src="<?php echo base_url(); ?>/assets/img/gallery/achivement2.jpg" alt="">
                        </div>
                        <div class="gallery-product col-md-3 filter events">
                            <img class="img-thumbnail img-fluid"
                                 src="<?php echo base_url(); ?>/assets/img/gallery/event1.jpg" alt="">
                        </div>
                        <div class="gallery-product col-md-3 filter events">
                            <img class="img-thumbnail img-fluid"
                                 src="<?php echo base_url(); ?>/assets/img/gallery/event2.jpg" alt="">
                        </div>
                        <div class="gallery-product col-md-3 filter achivements">
                            <img class="img-thumbnail img-fluid"
                                 src="<?php echo base_url(); ?>/assets/img/gallery/achivement3.jpg" alt="">
                        </div>
                        <div class="gallery-product col-md-3 filter achivements" style="height: 201px">
                            <img class="img-thumbnail img-fluid"
                                 src="<?php echo base_url(); ?>/assets/img/gallery/certificate.jpeg" alt="">
                        </div>
                        <div class="gallery-product col-md-3 filter achivements">
                            <img class="img-thumbnail img-fluid"
                                 src="<?php echo base_url(); ?>/assets/img/gallery/achivement5.jpg" alt="">
                        </div>
                        
                        <div class="gallery-product col-md-3 filter events">
                            <img class="img-thumbnail img-fluid"
                                 src="<?php echo base_url(); ?>/assets/img/gallery/event3.jpg" alt="">
                        </div>
                        <div class="gallery-product col-md-3 filter events">
                            <img class="img-thumbnail img-fluid"
                                 src="<?php echo base_url(); ?>/assets/img/gallery/event4.jpg" alt="">
                        </div>
                        <div class="gallery-product col-md-3 filter events">
                            <img class="img-thumbnail img-fluid"
                                 src="<?php echo base_url(); ?>/assets/img/gallery/event5.jpg" alt="">
                        </div>
                        <div class="gallery-product col-lg-3 col-md-3 col-sm-4 col-xs-6 filter videos"style="height: 201px">
                            <div class="embed-responsive embed-responsive-16by9">
                                <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/qk7RS8JHKyY" 
                        ...
                        <div class="gallery-product col-md-3 filter videos">
                            <img class="img-thumbnail img-fluid"
                                 src="<?php echo base_url(); ?>/assets/img/promotions/Sariputta7.jpeg" alt="addmission">
                        </div>
                        <div class="gallery-product col-md-3 filter videos">
                            <img class="img-thumbnail img-fluid"
                                 src="<?php echo base_url(); ?>/assets/img/promotions/Sariputta5.jpeg" alt="mbbs">
                        </div>
                        <div class="gallery-product col-md-3 filter videos">
                            <img class="img-thumbnail img-fluid"
                                 src="<?php echo base_url(); ?>/assets/img/promotions/Sariputta2.jpeg" alt="paramedical">
                        </div>
                        <div class="gallery-product col-md-3 filter achivements">
                            <img class="img-thumbnail img-fluid"
                                 src="<?php echo base_url(); ?>/assets/img/gallery/achivement4.jpeg" alt="">
                        </div>
                        
                        <div class="gallery-product col-md-3 filter videos">
                            <img class="img-thumbnail img-fluid"
                                 src="<?php echo base_url(); ?>/assets/img/promotions/Sariputta3.jpeg" alt="mba">
                        </div>
                          
                        <div class="gallery-product col-md-3 filter videos">
                            <img class="img-thumbnail img-fluid"
                                 src="<?php echo base_url(); ?>/assets/img/promotions/Sariputta1.jpeg" alt="abroad">
                        </div>
                        ...
                        <div class="gallery-product col-md-3 filter videos" style="height: 371px">
                            <img class="img-thumbnail img-fluid"
                                 src="<?php echo base_url(); ?>/assets/img/promotions/Sariputta4.jpeg" alt="diet">
                        </div>
                        
                        <div class="gallery-product col-md-3 filter videos" style="height: 371px">
                            <img class="img-thumbnail img-fluid"
                                 src="<?php echo base_url(); ?>/assets/img/promotions/Sariputta6.jpeg" alt="dmlt">
                        </div>
                        <div class="gallery-product col-md-3 filter videos" style="height: 371px">
                            <img class="img-thumbnail img-fluid"
                                 src="<?php echo base_url(); ?>/assets/img/promotions/Sariputta8.jpeg" alt="test">
                        </div>
                        <div class="gallery-product col-md-3 filter videos" style="height: 371px">
                            <img class="img-thumbnail img-fluid"
                                 src="<?php echo base_url(); ?>/assets/img/promotions/Sariputta11.jpeg" alt="test">
                        </div>
                        <div class="gallery-product col-md-3 filter videos" style="height: 371px">
                            <img class="img-thumbnail img-fluid"
                                 src="<?php echo base_url(); ?>/assets/img/promotions/Sariputta12.jpeg" alt="test">
                        </div>
                        <div class="gallery-product col-md-3 filter videos" style="height: 371px">
                            <img class="img-thumbnail img-fluid"
                                 src="<?php echo base_url(); ?>/assets/img/promotions/Sariputta13.jpeg" alt="test">
                        </div>
                        <div class="gallery-product col-md-3 filter videos" style="height: 371px">
                            <img class="img-thumbnail img-fluid"
                                 src="<?php echo base_url(); ?>/assets/img/promotions/Sariputta14.jpeg" alt="test">
                        </div>
                        <div class="gallery-product col-md-3 filter videos" style="height: 371px">
                            <img class="img-thumbnail img-fluid"
                                 src="<?php echo base_url(); ?>/assets/img/promotions/Sariputta15.jpeg" alt="test">
                        </div>
                        <div class="gallery-product col-md-3 filter videos" style="height: 371px">
                            <img class="img-thumbnail img-fluid"
                                 src="<?php echo base_url(); ?>/assets/img/promotions/Sariputta16.jpeg" alt="test">
                        </div>
                        <div class="gallery-product col-md-3 filter videos" style="height: 371px">
                            <img class="img-thumbnail img-fluid"
                                 src="<?php echo base_url(); ?>/assets/img/promotions/Sariputta17.jpeg" alt="test">
                        </div>
