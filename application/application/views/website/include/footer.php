                    ...
                    <div class="col-md-3 col-sm-6 footer-col-4">
                        <div class="widget ">
                            ...
                            <ul class="widget_getintuch">
                                ...
                                <li><a href="tel:+918035038282"><i class="fas fa-phone"></i><strong class="text-white">phone</strong>+91 80 3503 8282</a></li>
                ...
                <div class="footer-info-box clearfix p-tb30 p-lr15">
                    <div class="col-md-12 col-sm-6">
                        <div class="text-right">
                            <p class="text-right m-t10 m-b0">Copyright © Sariputta Edutech LLP 2020</p>
                            <p class="text-right m-t10 m-b0">Developed by <a href="https://www.sariputtatechnologies.co.in/" target="_blank">Sariputta Technologies</a></p>
                        </div>  
                    </div>
                </div>
            </div>
