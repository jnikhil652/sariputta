            ...
            <section class="section-full content-inner">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-6 m-b30">
                            ...
                            <div class="ow-carousel-entry">
                                ...
                                <div class="ow-entry-content p-a15">
                                    ...
                                    <div class="ow-entry-title"><h4 class="m-tb0"><a>Training and
                                ...
                                <div class="ow-entry-footer text-center">
                                    <button name="submit" type="submit" value="Submit" 
                                            class="site-button"  data-toggle="modal" data-target="#training" data-target="#training"><span>Enquiry</span></button>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4 col-sm-6 m-b30">
                            <div class="ow-carousel-entry">
                                <div class="ow-entry-media rdx-img-effect zoom-slow"><a href="<?php echo base_url('placement'); ?>"><img
                                                    src="<?php echo base_url(); ?>/assets/img/placementServices.jpg"
                                                    alt=""></a></div>
                                <div class="ow-entry-content p-a15">
                                    <div class="ow-entry-title"><h4 class="m-tb0"><a href="<?php echo base_url('placement'); ?>">Placement Services</a>
                                        </h4></div>
                                    <div class="ow-entry-text">
                                ...
                                <div class="ow-entry-footer text-center">
                                    <button name="submit" type="submit" value="Submit"
                                            class="site-button"  data-toggle="modal" data-target="#placement"><span>Enquiry</span></button>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-6 m-b30">
                            <div class="ow-carousel-entry">
                                <div class="ow-entry-media rdx-img-effect zoom-slow"><a href="<?php echo base_url('higherEducation'); ?>"><img
                                                src="<?php echo base_url(); ?>/assets/img/distanceLearning.jpg" alt=""></a>
                                </div>
                                <div class="ow-entry-content p-a15">
                                    <div class="ow-entry-title"><h4 class="m-tb0"><a href="<?php echo base_url('higherEducation'); ?>">Distance Learning and Higher Education</a></h4></div>
                                    <div class="ow-entry-text">
                                ...
                                <div class="ow-entry-footer text-center">
                                    <button name="submit" type="submit" value="Submit"
                                            class="site-button"  data-toggle="modal" data-target="#higher"><span>Enquiry</span></button>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-6 m-b30">
                            <div class="ow-carousel-entry">
                                <div class="ow-entry-media rdx-img-effect zoom-slow"><a href="#"><img
                                                src="<?php echo base_url(); ?>/assets/img/rsz_stepapp1.jpg" alt=""></a>
                                </div>
                                <div class="ow-entry-content p-a15">
                                    <div class="ow-entry-title"><h4 class="m-tb0"><a href="<?php echo base_url('stepapp'); ?>">Stepapp For 6th to 12th student </a></h4>
                                    </div>
                                    <div class="ow-entry-text">
                                ...
                                <div class="ow-entry-footer text-center">
                                    <button name="submit" type="submit" value="Submit" 
                                            class="site-button " data-toggle="modal" data-target="#stepapp"><span>Enquiry</span></button>
                        ...
                        <div class="col-md-4 col-sm-6 m-b30">
                            <div class="ow-carousel-entry">
                                ...
                                <div class="ow-entry-content p-a15">
                                    <div class="ow-entry-title"><h4 class="m-tb0"><a href="<?php echo base_url('paramedical'); ?>">Paramedical courses, Healthcare & Sanitation Services</a></h4></div>
                                    <div class="ow-entry-text">
                                ...
                                <div class="ow-entry-footer text-center">
                                    <button name="submit" type="submit" value="Submit"
                                            class="site-button " data-toggle="modal" data-target="#paramedical" ><span>Enquiry</span></button>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-6 m-b10">
                            <div class="ow-carousel-entry">
                                <div class="ow-entry-media rdx-img-effect zoom-slow"><a href="http://gurcharanamacademy.in/" target="_blank"><img
                                                src="<?php echo base_url(); ?>/assets/img/rszgurcharnam1.jpg" alt=""></a>
                                </div>
                                <div class="ow-entry-content p-a15">
                                    <div class="ow-entry-title"><h4 class="m-tb0"><a href="http://gurcharanamacademy.in/" target="_blank">NEET/ JEE / Pre-Foundation</a></h4>
                                    </div>
                                    <div class="ow-entry-text">
                                ...
                                <div class="ow-entry-footer text-center">
                                    <button name="submit" type="submit" value="Submit" 
                                            class="site-button " data-toggle="modal" data-target="#gurcharanam" ><span>Enquiry</span></button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-6 m-b10">
                            <div class="ow-carousel-entry">
                                ...
                                <div class="ow-entry-content p-a15">
                                    <div class="ow-entry-title"><h4 class="m-tb0"><a href="<?php echo base_url('mbbsabrod'); ?>">
                                    International Education Consultant For MBBS Abroad</a></h4></div>
                                    <div class="ow-entry-text">
                    ...
                    Once you are sure about going abroad and have chosen a university, right from admission to visa to accommodation flight tickets (one way free )visa renewal every year is taken care by us. Our parent company is into the same field since last 11 years have till date helped at least 1000+ students get admission in various colleges abroad. All the process starts with a contract made on a stamp paper to keep it authentic and legal.
                       ...
                       <div class="col-md-4 col-sm-6 m-b10">
                            <div class="ow-carousel-entry">
                                ...
                                <div class="ow-entry-content p-a15">
                                    <div class="ow-entry-title"><h4 class="m-tb0"><a href="<?php echo base_url('medicalindia'); ?>">Education Consultant For India</a></h4></div>
                                    <div class="ow-entry-text">
                        ...
                        <div class="col-md-4 col-sm-6 m-b10">
                            <div class="ow-carousel-entry">
                                <div class="ow-entry-media rdx-img-effect zoom-slow"> <a href="<?php echo base_url('overseas'); ?>"><img src="<?php echo base_url(); ?>/assets/img/overseas.jpg" alt=""></a> </div>
                                <div class="ow-entry-content p-a15">
                                    <div class="ow-entry-title"><h4 class="m-tb0"><a href="<?php echo base_url('overseas'); ?>">Overseas Education Consultant</a></h4></div>
                                    <div class="ow-entry-text">
                                        <div class="container">
                                        ...
                                        <a href="overseas.pdf"><button name="submit" type="submit" value="Submit" class="site-button "> <span>Broucher</span> </button></a>
                        ...
                        <div class="col-md-4 col-sm-6 m-b10">
                            <div class="ow-carousel-entry">
                                ...
                                <div class="ow-entry-content p-a15">
                                    <div class="ow-entry-title"><h4 class="m-tb0"><a href="https://www.indianabacus.com/" target="_blank">Indian Abacus</a></h4></div>
                                    <div class="ow-entry-text">
                                    ...
                                    <button name="submit" type="submit" value="Submit" 
                                            class="site-button"><span>Video</span>
                                    </button></a>
                                    </div>
                                </div>
                           </div>
                        ...
                        <div class="col-md-4 col-sm-6 m-b10">
                            <div class="ow-carousel-entry">
                                <div class="ow-entry-media rdx-img-effect zoom-slow"> <a href="https://www.indianabacus.com/" target="_blank"><img src="<?php echo base_url(); ?>/assets/img/abacus.jpg" alt="" style="height: 241px"></a> </div>
                                <div class="ow-entry-content p-a15">
                                    <div class="ow-entry-title"><h4 class="m-tb0"><a href="https://www.indianabacus.com/" target="_blank">Modo Robotics</a></h4></div>
                                    <div class="ow-entry-text">
                                        
                                        <p>Modo envisions a world where our children are futuristic, digitally savvy and technologically skilled – who go on to solve big problems using technology and create the next big innovations that will impact human lives.</p>
                                        <br>
                        ...
                        <div class="col-md-4 col-sm-6 m-b10">
                            <div class="ow-carousel-entry">
                                <div class="ow-entry-media rdx-img-effect zoom-slow"><a href="#"><img
                                                src="<?php echo base_url(); ?>/assets/img/expertron.png" alt=""></a>
                                </div>
                                <div class="ow-entry-content2 p-a15">
                                    <div class="ow-entry-title"><h4 class="m-tb0"><a href="#">Expertron</a>
                                        </h4></div>
                                    <div class="ow-entry-text">
                                        ...
                                        <a href="Broucher.pdf"><button name="submit" type="submit" value="Submit" class="site-button " data-toggle="modal" data-target="#overseas"> <span>Broucher</span> </button></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-6 m-b10">
                            <div class="ow-carousel-entry">
                                ...
                                <div class="ow-entry-content p-a15">
                                    <div class="ow-entry-title"><h4 class="m-tb0"><a href="https://careertest.sariputtaedutech.co.in/" target="_blank">Career Counseling</a></h4></div>
                                    <div class="ow-entry-text">
                                        <div class="col">
                                        ...
                                        <p>
                                            ...
                                            <li>6)PERSONA- STUDENTS OVERALL PERSONA ACROSS</li>

                                            <li>10 UNIQUE PERSONALITY DIMENSIONS 7)SKILL GAP- DETAILES SKILL WISE DESCRIPTION WILL BE GIVEN</li>
						...
						<div class="col-md-4 col-sm-6 m-b10">
                            <div class="ow-carousel-entry">
                                <div class="ow-entry-media rdx-img-effect zoom-slow"> <a href="#" target="_blank"><img src="<?php echo base_url(); ?>/assets/img/brain.jpeg" alt="" style="height: 241px"></a> </div>
                                <div class="ow-entry-content p-a15">
                                    <div class="ow-entry-title"><h4 class="m-tb0"><a href="#" target="_blank">DMIT test</a></h4></div>
                                    <div class="ow-entry-text">
