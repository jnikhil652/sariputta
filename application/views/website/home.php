            ...
            <div class="container">
                ...
                <div class="section-content text-center ">
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6 m-b30">
                            <img class="img-fluid img-thumbnail" style="height:135px;width:265px;"
        ...
        <div class="section-full bg-white content-inner">
            <div class="container">
             <div class="section-head text-center ">
                ...
                <div class="row">
                        <div class="col-md-3 col-sm-6 m-b30">
                            <img class="img-fluid img-thumbnail" style="width:265px;height:151px;"
                                 src="<?php echo base_url(); ?>/assets/hdfc.png">
                        </div>
                        <div class="col-md-3 col-sm-6 m-b30">
                            <img class="img-fluid img-thumbnail" 
                                 src="<?php echo base_url(); ?>/assets/credin.jpg">
                        </div>
