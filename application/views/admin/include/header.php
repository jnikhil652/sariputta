<head>
    ...
    <!-- Icons -->
    <link rel="stylesheet" href="<?= base_url() ?>assets/admin/css/nucleo.css" type="text/css">
    <link rel="stylesheet" href="<?= base_url() ?>assets/admin/css/all.min.css" type="text/css">
    <!-- Page plugins -->
    <!-- Argon CSS -->
